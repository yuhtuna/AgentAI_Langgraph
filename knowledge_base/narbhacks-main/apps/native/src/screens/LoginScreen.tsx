        ...
        if (createdSessionId) {
          ...
          if (signUp && signUp.status === "missing_requirements") {
            ...
            if (isPhoneRequired) {
              ...
              try {
                // Ideally, we'd collect the phone number from the user here.
                // For now, we alert the user and prevent sign-up.
                Alert.alert(
                  "Phone Number Required",
                  "Your account requires a phone number. Please sign up with a phone number.",
                  [{ text: "OK" }]
                );
              } catch (_updateError) {
                Alert.alert(
